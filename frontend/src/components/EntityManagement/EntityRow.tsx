...
import RoleCombobox from '../UserManagement/RoleCombobox';
import EntityCombobox from '../UserManagement/EntityCombobox';
...
const EntityRow: React.FC<EntityRowProps> = ({ user, onActionClick, onRoleChange, onEntityChange, entities }) => {
